...
if __name__ == "__main__":
    label_path = "/home/data2/huanglang/datasets/Cityscape/val/label/"
    instance_path = "/home/data2/huanglang/datasets/Cityscape/val/instance/"
    edge_path = "/home/data2/huanglang/datasets/Cityscape/val/edge_instance/"
    if not os.path.exists(edge_path):
        os.makedirs(edge_path)
    
    generate_train_val_edge(instance_path, edge_path, 10, area_thrs=3600)

    label_edge2void_path = "/home/data2/huanglang/datasets/Cityscape/edge_inst_width10/val/label_edge_void/"
    label_nedge2void_path = "/home/data2/huanglang/datasets/Cityscape/edge_inst_width10/val/label_non_edge_void/"
